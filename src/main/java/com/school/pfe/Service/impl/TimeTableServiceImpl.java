...
public class TimeTableServiceImpl implements TimetableService{
	...
	@Override
	public Timetable save(Timetable planing) {
	...
	public TimetableDto timetableById(Long idTimetable) {
		if(idTimetable == null)
        {
            ...
            throw new InvalidOperationException("Impossible de trouver un emploi de temps avec un ID NULL", ErrorCodes.LEVEL_ID_IS_NULL);
        }
    ...
    public ResponseEntity<Void> delete(Long timetableId) {
        ...
        {
            log.error("Timetable ID is NULL ");
            throw new InvalidOperationException("Impossible de supprimer un emploi du temps  avec un ID NULL",ErrorCodes.LEVEL_ID_IS_NULL);
