...
public class FacultyServiceImpl implements FacultyService {
    ...
    public FacultyDto findById(Long id) {
        ...
        if (id == null) {
            ...
            throw new InvalidOperationException("Impossible de trouver une filière avec un ID NULL", ErrorCodes.FACULTY_ID_IS_NULL);
        }
    ...
    public FacultyDto findByCode(String code) {
        ...
        if (!StringUtils.hasLength(code)) {
            log.error("Faculty CODE is null");
            throw new InvalidOperationException("Impossible de trouver une filière avec un CODE NULL", ErrorCodes.FACULTY_CODE_IS_NULL);
        }
        Optional<Faculty> faculty = facultyRepository.findFacultyByCode(code);
    ...
    public void delete(Long id) {
        ...
        if (id == null) {
            log.error("Faculty ID is null");
            throw new InvalidOperationException("Impossible de supprimer une filière  avec un ID NULL",ErrorCodes.FACULTY_ID_IS_NULL);
        }
